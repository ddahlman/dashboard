...
function updateCssVar() {
    ...
    var numRows = parseInt(htmlStyles.getPropertyValue("--numRows"));
    var numCols = parseInt(htmlStyles.getPropertyValue("--numCols"));
    var gridItemsCount = document.querySelectorAll('.draggable').length + 1;
